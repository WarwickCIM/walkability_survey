...
image_path <- "https://raw.githubusercontent.com/WarwickCIM/walkability_gsv/gsv_img/img/"
...
A questionnaire was published during `r min(df$start_date)`and `r max(df$start_date)`.
We got `r nrow(df)` responses.
Respondents were selected following these criteria: \* Living in the UK
