...
ratings_df %>% 
  ...
  mutate(img = paste0("<a href='https://raw.githubusercontent.com/WarwickCIM/walkability_gsv/gsv_img/img/",image_num, "_composite.jpg'>",
      "<img src='https://raw.githubusercontent.com/WarwickCIM/walkability_gsv/gsv_img/img/s/", image_num, "_composite.jpg' width='100px'> </a>")) %>% 
...
ratings_df %>% 
  ...
  mutate(img = paste0("<a href='https://raw.githubusercontent.com/WarwickCIM/walkability_gsv/gsv_img/img/",image_num, "_composite.jpg'>",
      "<img src='https://raw.githubusercontent.com/WarwickCIM/walkability_gsv/gsv_img/img/s/", image_num, "_composite.jpg' width='260px'> </a>")) %>% 
  relocate(img, .after = image_num) %>% 
